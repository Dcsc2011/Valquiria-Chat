          ...
          {results.length === 0 ? (
            ...
            results.map((u) => (
              <button
                ...
                className="flex w-full items-center gap-3 px-3 py-2.5 text-left hover:bg-panelHeader"
              >
                ...
                <span className="flex items-center gap-1 rounded-md bg-accent/20 px-2 py-1 text-xs font-medium text-accent">
